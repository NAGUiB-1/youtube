...
function VideoPage() {
    ...
    if (data.title) {
        return (
            <div className="xl:grid xl:grid-cols-4 gap-8 flex flex-col">
                <div className='xl:col-start-1 xl:col-end-4  w-full h-full top-[3rem] '>
                    {/*Video player*/}
                    <div className="  h-[200px] w-full sm:h-[300px] lg:h-[400px] xl:h-[550px] ">
                        <ReactPlayer
                    ...
                    <div className="flex flex-row items-center justify-between sm:text-xl lg:text-3xl xl:text-4xl  px-4 pb-4">
                        <div className=" flex items-center flex-row gap-3 ">
                            ...
                            <p className=" text-white">
                                ...
                                <span className="opacity-50 whitespace-pre sm:text-lg lg:text-xl xl:text-2xl ">
                                    {" "}
                                    {newSubs}
                                </span>{" "}
                            </p>
                ...
                <div className='w-full xl:col-start-4 xl:col-end-5 flex'>
